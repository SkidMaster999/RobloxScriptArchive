--https://github.com/Chaosscripter/CorgiSideExploits-OrionLib/blob/main/Corgiside%20Prison%20Life
...
local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Chaosscripter/Riotscripter/refs/heads/main/Orion%20Library%203", true))()

local Window = OrionLib:MakeWindow({Name = "Riotscripter | Prison Life", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
local Settings = {
	...
	JoinNotify = false;
	PrintDebug = string.sub(LocalPlayer.Name, 1, 5) == "Riotscripter" or string.sub(LocalPlayer.Name, 1, 9) == "Riotscripter";
	User = {
		RankedCmds = true;
		HiddenMelee = false;
		HiddenArrest = false;
...
PlayerSection:AddToggle({
	...
	Callback = function(Value)
		...
		Notif("Riotscripter Exploits", "Successfully Set Noclip: "..tostring(Value))
	end    
})
	...
	Callback = function()
		for i,x in ipairs(Players:GetPlayers()) do
			if x ~= LocalPlayer then
				loadstring(game:HttpGet("https://raw.githubusercontent.com/Chaosscripter/CorgiSideExploits-OrionLib/refs/heads/main/SkidFling", true))()
			end
		end
	end,
})
...
GunSection:AddDropdown({
	...
	Callback = function(Value)
		Gun(Value)
		Notif("Riotscripter Exploits", "Successfully Obtained "..Value)
	end    
})
...
GunSection:AddButton({
	...
	Callback = function()
		...
		Gun("M9")
		Gun("M4A1")
		Notif("Riotscripter Exploits", "Successfully Obtained All Guns")
	end    
})

GunSection:AddButton({
	Name = "Get All Guns 2 (No Gamepass Gun!)",
	Callback = function()
		Gun("AK-47")
		Gun("Remington 870")
		Gun("M9")
...
GunSection:AddToggle({
	...
	Callback = function(Value)
		...
		if Toggles.AutoGuns then
			Threads.AutoGuns()
			Notif("Riotscripter Exploits", "Successfully Enabled Autoguns")
		else
			Notif("Riotscripter Exploits", "Successfully Disabled Autoguns")
		end
...
GunSection:AddToggle({
	Name = "Loop Guns 2 (No Gamepass Gun!)",
	Default = false,
	Callback = function(Value)
		Toggles.AutoGuns_2 = Value

		if Toggles.AutoGuns_2 then
			Threads.AutoGuns_2()
			Notif("Riotscripter Exploits", "Successfully Enabled Autoguns 2")
		else
			Notif("Riotscripter Exploits", "Successfully Disabled Autoguns 2")
		end
...
GunModSection:AddDropdown({
	...
	Callback = function(Value)
		...
		if Gun then
			...
			Notif("Riotscripter Exploits", "No Gun Equipped!", 4)
		end
	end    
})
...
ModPlayerSection:AddToggle({
	...
	Callback = function(Value)
		if ScriptLoaded then
			...
			Notif("Riotscripter Exploits", "Successfully Set One Punch: "..Value)
		end
	end   
})
...
ModPlayerSection:AddToggle({
	...
	Callback = function(Value)
		if ScriptLoaded then
			...
			Notif("Riotscripter Exploits", "Successfully Set Spam Punch: "..Value)
		end
	end   
})
...
ModPlayerSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Gave Keycard")
	end   
})
...
ModPlayerSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Loaded Btools")
	end   
})
...
ServerPlayerSection:AddToggle({
	...
	Callback = function(Value)
		...
		if Value == true then
			Toggles[x] = true
			Notif("Riotscripter Exploits", "Successfully Enabled Auto Respawn")
		elseif Value == false then
			Toggles[x] = nil
			Notif("Riotscripter Exploits", "Successfully Disabled Auto Respawn")
		end
	end    
})
...
ModPlayerSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Loaded Normal Scythe")
	end    
})
...
ModPlayerSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Loaded Bone Scythe")
	end    
})
...
ModPlayerSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Loaded Rainbow Sword")
	end    
})
...
ModPlayerSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Loaded Classic Sword")
	end    
})
...
ModPlayerSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Loaded Speed Coil")
	end,
})
...
ModPlayerSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Loaded Gravity Coil")
	end,
})
...
ServerTeamSection:AddButton({
	...
	Callback = function()
		TeamTo("criminal")
		Notif("Riotscripter Exploits", "Successfully Transitioned to Criminal")
	end    
})
...
ServerTeamSection:AddButton({
	...
	Callback = function()
		TeamTo("guard")
		Notif("Riotscripter Exploits", "Successfully Transitioned to Guard")
	end    
})
...
ServerTeamSection:AddButton({
	...
	Callback = function()
		TeamTo("inmate")
		Notif("Riotscripter Exploits", "Successfully Transitioned to Inmate")
	end    
})
...
ServerTeamSection:AddButton({
	...
	Callback = function()
		TeamEve("Medium stone grey")
		Notif("Riotscripter Exploits", "Successfully Transitioned to Neutral")
	end    
})
...
ServerFESection:AddButton({
	...
	Callback = function()
		MultiKill(Players); 
		Notif("Riotscripter Exploits", "Successfully Killed All")
	end    
})
...
ServerFESection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Killed All Guards")
	end    
})
...
ServerFESection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Killed All Criminals")
	end    
})
...
ServerFESection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Killed All Inmates")
	end    
})
...
ServerFESection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Killed All Neutrals")
	end    
})
...
ServerFESection:AddButton({
	...
	Callback = function()
		if workspace.Doors then
			...
			Notif("Riotscripter Exploits", "Successfully Destroyed Doors")
		else
			Notif("Riotscripter Exploits", "Doors Already Destroyed!", 5)
		end
	end    
})	
...
ServerFESection:AddButton({
	...
	Callback = function()
		if Rstorage.Doors then
			...
			Notif("Riotscripter Exploits", "Successfully Restored Doors")
		else
			Notif("Riotscripter Exploits", "Doors Already Exist!", 5)
		end
	end    
})
...
ServerFESection:AddButton({
	...
	Callback = function()
		OpenDoors(true);
		Notif("Riotscripter Exploits", "Successfully Opened All Doors")
	end
})
...
ServerFESection:AddTextbox({
	...
	Callback = function(Value : string)
		...
		if Players:FindFirstChild(Value) then
			...
			KillPL(y)
			Notif("Riotscripter Exploits", "Successfully Killed Player: "..Value, 5)
		else
			Notif("Riotscripter Exploits", "Invalid Player: "..Value, 5)
		end
	end	  
})
...
ServerMiscelaneousSection:AddToggle({
	...
	Callback = function(Value)
		if Value == true then
			...
			Notif("Riotscripter Exploits", "Successfully Spamming Sounds!")
		elseif Value == false then
			States.SoundSpam = false;
			Notif("Riotscripter Exploits", "Successfully Unspamming Sounds!")
		end
	end,
})
...
LoopsMainSection:AddToggle({
	...
	Callback = function(Value)
		if Value == true then
			...
			Notif("Riotscripter Exploits", "Successfully Loopkilled All")
		elseif Value == false then
			Loops.KillTeams.All = false;
			Notif("Riotscripter Exploits", "Successfully Unloopkilled All")
		end
	end,
})
...
LoopsMainSection:AddToggle({
	...
	Callback = function(Value)
		if Value == true then
			...
			Notif("Riotscripter Exploits", "Successfully Loopkilled Guards")
		elseif Value == false then
			Loops.KillTeams.Guards = false;
			Notif("Riotscripter Exploits", "Successfully Unloopkilled Criminals")
		end
	end,
})
...
LoopsMainSection:AddToggle({
	...
	Callback = function(Value)
		if Value == true then
			...
			Notif("Riotscripter Exploits", "Successfully Loopkilled Inmates")
		elseif Value == false then
...
LoopsMainSection:AddToggle({
	...
	Callback = function(Value)
		if Value == true then
			...
			Notif("Riotscripter Exploits", "Successfully Loopkilled Criminals")
		elseif Value == false then
...
LoopsMainSection:AddToggle({
	Name = "Loopkill Neutrals",
	Default = false,
	Callback = function(Value)
		if Value == true then
			Loops.KillTeams.Neutrals = true;
			Notif("Riotscripter Exploits", "Successfully Loopkilled Neutrals")
		elseif Value == false then
			Loops.KillTeams.Neutrals = false;
			Notif("Riotscripter Exploits", "Successfully Unloopkilled Neutrals")
		end
	end,
})
...
LoopsMainSection:AddTextbox({
	...
	Callback = function(Value : string)
		...
		if Players:FindFirstChild(Value) then
			...
			Notif("Riotscripter Exploits", "Successfully Loopkilled Player: "..Value, 5)
		else
			Notif("Riotscripter Exploits", "Invalid Player: "..Value, 5)
		end
	end	  
...
LoopsMainSection:AddTextbox({
	...
	Callback = function(Value : string)
		...
		if Players:FindFirstChild(Value) then
			...
			Notif("Riotscripter Exploits", "Successfully Unloopkilled Player: "..Value, 5)
		else
			Notif("Riotscripter Exploits", "Invalid Player: "..Value, 5)
		end
	end	  
...
CreditsMainSection:AddParagraph("CREDITS","Hello, fellow exploiter! I am the owner of Riotscripter Exploits, which is the owner of this script that you are currently using right now. I would like to credit some people that had their code used in this script. The owner of PrizzLife(); is being credited for their script, Infinite Yield creators for their IY script, Impact Hub is being credited for their script, and finally, ic3wolf is being credited for Unnamed ESP. Everything else however, was made by me. Furthermore, no other credits are going to be given.")

ExtraScriptsMainSection:AddButton({
	Name = "Infinite Yield";
	Callback = function()
		loadstring(game:HttpGet(('https://raw.githubusercontent.com/Chaosscripter/infiniteyield/master/source'),true))()
		Notif("Riotscripter Exploits", "Successfully Loaded Infinite Yield")
	end,
})
...
ExtraScriptsMainSection:AddButton({
	...
	Callback = function()
		loadstring(game:HttpGet('https://raw.githubusercontent.com/Chaosscripter/Prison-Life-Admin-Commands/refs/heads/main/Prison%20Life%20Admin%20Commands.lua'))()
		Notif("Riotscripter Exploits", "Successfully Loaded Prison Life Admin")
	end,
})
...
ExtraScriptsMainSection:AddButton({
	Name = "Corgi's ESP";
	Callback = function()
		loadstring(game:HttpGet('https://raw.githubusercontent.com/Chaosscripter/Corgi-s-ESP/refs/heads/main/Deobfuscated', true))()
		Notif("Riotscripter Exploits", "Successfully Loaded Corgi's ESP")
	end,
})
...
ExtraScriptsMainSection:AddButton({
	...
	Callback = function()
		loadstring(game:HttpGet('https://raw.githubusercontent.com/Chaosscripter/FE-Gear-Giver-Mod-PRison-Life-UnOb/refs/heads/main/Code', true))()
		Notif("Riotscripter Exploits", "Successfully Loaded Corgi's ESP")
	end,
})
...
ExtraScriptsMainSection:AddButton({
	...
	Callback = function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Chaosscripter/Prison-Life-Admin-Commands/refs/heads/main/Old-Gui"))()
		Notif("Riotscripter Exploits", "Successfully Loaded OG Exploiting GUI")
	end,
})
...
ExtraScriptsMainSection:AddButton({
	Name = "Unnamed ESP";
	Callback = function()
		pcall(function() loadstring(game:HttpGet('https://raw.githubusercontent.com/Chaosscripter/Unnamed-ESP/master/UnnamedESP.lua'))() end)
		Notif("Riotscripter Exploits", "Successfully Loaded Unnamed ESP")
	end,
})
...
ExtraScriptsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Loaded Impact Hub")
	end,
})
...
ExtraScriptsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Loaded PrizzLife();")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To NSpawn")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Cells")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Nexus")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Armory")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Yard")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Crimbase")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Cafe")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Kitchen")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Roof")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Vents")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Office")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To YTower")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To GTower")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Garage")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Sewers")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Neighborhood")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Gas")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Dead End")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Store")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Road End")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Trap Building")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Mansion")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Trap Base")
	end,
})
...
TeleportsMainSection:AddButton({
	...
	Callback = function()
		...
		Notif("Riotscripter Exploits", "Successfully Teleported To Building Roof")
	end,
})
...
Threads = {
	...
	AutoGuns_2 = function()
		if not Toggles.AutoGuns_2 then
			return
		end; Toggles.AutoItems = false
		task.spawn(function()
			while Toggles.AutoGuns_2 do task.wait()
				pcall(AllGuns_2)
				if Settings.User.OldItemMethod then
					LocalPlayer.CharacterAdded:Wait(); wait(1)
				end
	...
	AutoItems = function()
		if not Toggles.AutoItems_2 then
			return
		end; Toggles.AutoGuns = false
		task.spawn(function()
			while Toggles.AutoItems_2 do task.wait()
				task.spawn(AllItems)
				LocalPlayer.CharacterAdded:Wait()
	...
	AutoItems_2 = function()
		if not Toggles.AutoItems_2 then
			return
		end; Toggles.AutoGuns_2 = false
		task.spawn(function()
			while Toggles.AutoItems_2 do task.wait()
				task.spawn(AllItems_2)
				LocalPlayer.CharacterAdded:Wait()
				if waitfor(LocalPlayer.Character, "HumanoidRootPart", 1) and Settings.User.OldItemMethod and LocalPlayer.TeamColor == BrickColor.new("Bright blue") then
					RTPing(1)
				end
